                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-2">
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="form-control w-full">
                            ...
                            <input type="date"{...register("availability_date")} className="input input-bordered w-full" />
                        </div>
                    </div>
                    <div className="flex items-center gap-5">
                        <div className="form-control w-full">
                    ...
                    <div className="form-control w-full">
                        ...
                        <input type="file" {...register("picture")} className="file-input file-input-bordered file-input-primary w-full" />
                    </div>
                    <div className="mt-3">
